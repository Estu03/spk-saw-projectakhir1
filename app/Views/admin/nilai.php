                            ...
                            <tbody>
                                <?php foreach ($data as $d) {?>
                                    <tr>
                                        ...
                                        <?php } ?>
                                        <td align="center"><button type="button" data-toggle="modal" data-target="#nilai<?php echo $d['kodekaryawan'] ?>" class="btn btn-warning btn-xs">Detail</button></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
